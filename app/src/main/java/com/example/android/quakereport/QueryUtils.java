...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeEntry> extractEarthquakeEntrys() {
        ...
        try {
            ...
            for (int i=0; i<featuresArray.length(); i++) {
                ...
                EarthquakeEntry earthquakeEntry = new EarthquakeEntry(Double.parseDouble(mag),
                        place, time);
